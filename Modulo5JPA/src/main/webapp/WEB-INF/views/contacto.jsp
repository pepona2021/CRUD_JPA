    ...
    <div class="container">
        <div class="contact-box">
            ...
            <div class="right">
                ...
                <form action="Contacto" method="post" id="Fcontacto" >
                ...
                <input type="tel" class="field" id="telefono" name="telefono"placeholder="Telefono">
                <textarea placeholder="Message" id="mensaje" name="mensaje"class="field"></textarea>
