    ...
    <div class="container">
        <div class="contact-box">
            ...
            <div class="right">
                ...
                <form action="${pageContext.request.getContextPath()}/crearcapacitacion" method="post">
		        <div class="mb-3">
		        ...
		        <div class="mb-3">
		            ...
		            <input type="text" class="form-control" id="dia" name="dia">   <!-- se cambio el type = date por string para el ejercicio -->
		        </div>
		        <div class="mb-3">
		            <label for="hora" class="form-label">Hora</label>
		            <input type="text" class="form-control" id="hora" name="hora"> <!-- se cambio el type = date por string para el ejercicio -->
		        </div>
		        <div class="mb-3">
