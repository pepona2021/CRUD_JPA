    ...
    <div class="container">
        <div class="contact-box">
            ...
            <div class="right">
                ...
                <form action="${pageContext.request.getContextPath()}/editarCapacitacion/${c.getId()}" method="post">
                <input type="hidden" id="id" name="id" value="${c.getId()}">
				<div class="mb-3">
					<label for="rutCliente" class="form-label">rutCliente</label>
					<input type="text" 	class="form-control" id="rutCliente" name="rutCliente" value="${c.getRutCliente()}">
				</div>
				
				<div class="mb-3">
					<label for="dia" class="form-label">dia</label>
					<input type="text" 	class="form-control" id="dia" name="dia" value="${c.getDia()}">
				</div>
				
				<div class="mb-3">
					<label for="hora" class="form-label">hora</label>
					<input type="text" 	class="form-control" id="hora" name="hora" value="${c.getHora()}">
				</div>
				<div class="mb-3">
					<label for="lugar" class="form-label">lugar</label>
					<input type="text" 	class="form-control" id="lugar" name="lugar" value="${c.getLugar()}">
				</div>
				
				<div class="mb-3">
					<label for="duracion" class="form-label">duracion</label>
					<input type="text" 	class="form-control" id="duracion" name="duracion" value="${c.getDuracion()}">
				</div>
